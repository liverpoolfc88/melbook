...
//------------------------------------------------------------------------------------------------//
    ...
    {
        $youtube = Youtube::find()->all();
        $percent = Percent::find()->one();
//        $word1 = Changes::find()->where(['id'=>1])->one();
        $word2 = Changes::find()->where(['id'=>2])->one();
        $word3 = Changes::find()->where(['id'=>3])->one();
        $word4 = Changes::find()->where(['id'=>4])->one();
        $word5 = Changes::find()->where(['id'=>5])->one();
//        $word6 = Changes::find()->where(['id'=>6])->one();
//        $word7 = Changes::find()->where(['id'=>7])->one();
        // var_dump(Changes::find(2)->one()); die();
        $questionanswer = Questionanswer::find()->all();
        $model = new Client();
        $book = Book::find()->all();
...
//            'youtube'=> $youtube,
            ...
            'summ' => $percent->summ,
//            'wordsone'=>$word1->words1,
//            'wordstwo'=>$word1->words2,
            'word2'=>$word2->words1,
            'word3'=>$word3->words1,
            'word41'=>$word4->words1,
            'word42'=>$word4->words2,
...
//        \Yii::$app->response->format = Response::FORMAT_JSON;
    ...
    public function actionOrder(){
        ...
        Yii::$app->response->format = 'json';
        return ['data' => 'success', 'chekk'=> $chek];
    }
