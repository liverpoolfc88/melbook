...
<div class="site-index">
    ...
    <div class=" row jumbotron">
        ...
        <div id="sasa" style="display: flex">
            <? foreach ($book as $key => $val): ?>
                ...
                <div>
                    <input class="chek" type="checkbox" id="<?=$val->id?>" data-kod="<?=$val->kod?>" data-name="<?=$val->name?>">
    ...
    <section>
        <div class="container">
            <div class="row">
                <? $youtube = \app\models\Youtube::find()->all(); foreach ($youtube as $val): ?>
<!--                --><?// var_dump($val->link); ?>
                <div class="col-md-4">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?=$val->link?>" frameborder="0"
